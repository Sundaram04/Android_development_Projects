package com.example.building_a_grid.data

import com.example.building_a_grid.R
...
object DataSource {
    val topics = listOf(
        ...
        Topic(R.string.journalism, 121, R.drawable.journalism),
        Topic(R.string.law, 121, R.drawable.law),
    )
}
